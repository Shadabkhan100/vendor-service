...
<h1 class="display-5 mb-4">Connecting You with Trusted Service Professionals</h1>
<p class="mb-4">
We are a multi-service marketplace platform designed to connect customers with verified service providers across multiple categories. From roadside assistance to home maintenance and transport services, our system ensures secure booking, transparent communication, and protected payments.
</p>
                            <div class="row g-4">
...
<p>
Your payment is protected and only released after service completion and satisfaction confirmation.
</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 col-lg-6 col-xl-6">
                                    <div class="d-flex">
                                        ...
                                        <div class="ms-4">
                                            <h4>Verified Vendors & Stores</h4>
<p>
We onboard trusted vendors and local stores to provide reliable services and quality products.
</p>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="col-xl-5 wow fadeInRight" data-wow-delay="0.2s">
                        <div class="bg-primary rounded position-relative overflow-hidden">
                            <img src="{{ asset('assets/img/about-1.jpg') }}" class="img-fluid rounded w-100" alt="">
                            
                            <div class="" style="position: absolute; top: 2px; right: 2px;">
                                <img src="{{ asset('assets/img/about-3.png') }}" class="img-fluid" style="width: 150px; height: 130px; opacity: 0.7;" alt="">
                            </div>
                            <div class="" style="position: absolute; top: 2px; left: 2px; ">
                                <img src="{{ asset('assets/img/about-4.png') }}" class="img-fluid" style="width: 100px; height: 130px; opacity: 0.9;" alt="">
                            </div>
                            <div class="rounded-bottom">
                                <img src="{{ asset('assets/img/about-2.jpg') }}" class="img-fluid rounded-bottom w-100" alt="">
                            </div>
                        </div>
                    </div>
                </div>
...
<h1 class="display-5 mb-4">Smart Solutions for Everyday Needs</h1>
<p class="mb-0">
Our marketplace connects you with skilled service providers across multiple categories. Book services instantly, communicate directly with vendors, and enjoy secure escrow-based payments designed to protect both customers and professionals.
</p>
                </div>
                <div class="row g-4">
...
Smart Marketplace Solutions for Modern Service Businesses.
</h1>
<p class="mb-0">
We help businesses and service providers connect with customers through a secure, scalable, and intelligent marketplace platform featuring verified vendors, escrow payment protection, and real-time communication tools.
</p>
                </div>
                <div class="row g-4">
    ...
    <div class="feature-item p-4">
        ...
        <p class="mb-4">
        Connect with trusted and verified vendors offering professional services across multiple categories.
        </p>
...
<div class="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.4s">
    <div class="feature-item p-4">
        ...
        <h4>Secure Escrow Payments</h4>
        <p class="mb-4">
        Payments are securely held and released only after service completion and customer satisfaction.
        </p>
        <a class="btn btn-primary rounded-pill py-2 px-4" href="#">Learn More</a>
    </div>
</div>
...
<div class="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.6s">
    <div class="feature-item p-4">
        ...
        <p class="mb-4">
        Communicate instantly with service providers using built-in messaging and support chat features.
        </p>
        <a class="btn btn-primary rounded-pill py-2 px-4" href="#">Learn More</a>
    </div>
</div>
...
<div class="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.8s">
    <div class="feature-item p-4">
        ...
        <p class="mb-4">
        Vendors can create stores, sell products, manage services, and grow their business online & can grow the earning through
